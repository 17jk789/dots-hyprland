...
hl.layer_rule({ match = { namespace = "quickshell:.*" }, ignore_alpha = 0.15})
...
hl.layer_rule({ match = { namespace = "quickshell:overlay" }, ignore_alpha = 0.15})
...
hl.layer_rule({ match = { namespace = "quickshell:popup" }, ignore_alpha = 0.15}) -- No weird color for bar tooltips (but somehow this is necessary)
hl.layer_rule({ match = { namespace = "quickshell:mediaControls" }, ignore_alpha = 0.15}) -- Same as above
...
hl.layer_rule({ match = { namespace = "quickshell:session" }, ignore_alpha = 0.15})
...
hl.layer_rule({ match = { namespace = "quickshell:wTaskView" }, ignore_alpha = 0.15})
